...
# Implement Stack Using Queue (use 1 queue)
```java
class MyStack {
...
# python - use class queue.LifoQueue()
...
# python - use module collections class deque 
```py
...
# python - Implement Stack Using Queue (use class queue.Queue())
```py
import queue
class MyStack:
